			...
			<Dialog.Panel control={state}>
				{(close) => (
					<>
						...
						<Dialog.Text>
							<p className="text-base font-medium mb-0 mt-0">Subnet routes</p>
						</Dialog.Text>
						<Dialog.Text>
						...
						<Dialog.Text>
							<p className="text-base font-medium mb-0 mt-2">Exit Node</p>
						</Dialog.Text>
						<Dialog.Text>
							<p className="text-sm font-normal mb-0 mt-1">
								Allow your network to route internet traffic through this
								machine.{" "}
								<Link
							...
							>
								...
								<Switch
									...
									onChange={(checked) => {
										...
										form.set(
											"route",
											routes.find((route) => route.prefix === "0.0.0.0/0")
												?.id as string,
										);
										...
										form.set(
											"route",
											routes.find((route) => route.prefix === "::/0")
												?.id as string,
										);
										fetcher.submit(form, {
											method: "POST",
