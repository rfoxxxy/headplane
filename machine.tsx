	...
	return (
		<div>
			<p className="mb-8 text-md">
				<ReactLink to="/machines" className="font-medium">
					All Machines
				</ReactLink>
			...
			<h2 className="text-xl font-medium mb-0 mt-8">Routing Settings</h2>
			...
			<Card variant="flat" className="w-full max-w-full">
				...
				>
					<div>
						<p className="font-medium mb-1">Exit Node</p>
			...
			<h2 className="text-xl font-medium mb-0 mt-8">Subnets</h2>
			<h5 className="text-sm font-normal text-gray-400 mb-3 mt-1.5">
				...
				{routes.filter((route) => {
					...
					routes
						...
						.map((route, _i) => (
							...
							>
								<div>
									<p className="font-mono mb-1">{route.prefix}</p>
									<p className="text-sm text-ui-600 dark:text-ui-300">
										{" "}
